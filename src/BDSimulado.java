...
public class BDSimulado {
    ...
    //Questão 2a
    public ArrayList<Cliente> getInfoCliente(String nome){
    ...
    public int ligacoesPorUF(String UF){
    	...
    	for (int i = 0; i < this.ligacoes.size(); i++) {
    		if (this.ligacoes.get(i).getClienteLigação().getUF().equals(UF)) {
    			resultado ++;
    ...
    public ArrayList<Integer> ligacoesUFDiferente(){
    	...
    	for (int i = 0; i < this.ligacoes.size(); i++) {
    		if (this.ligacoes.get(i).getClienteLigação().getUF() != this.ligacoes.get(i).getUFDestino()) {
    			resultado.add(this.ligacoes.get(i).getCódigo());
